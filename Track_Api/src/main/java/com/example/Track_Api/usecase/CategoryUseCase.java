...
public class CategoryUseCase implements ICategory {
	...
	{
		Category retrievedCategory = categoryGateway.findByIdTheCategory(categoryId);
		
		if(!retrievedCategory.getCateExpense().equals(theCategory.getCateExpense())){
		...
		return categoryGateway.createAndReturn(retrievedCategory);    
	}
